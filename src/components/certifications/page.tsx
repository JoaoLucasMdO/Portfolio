...
export default function Certifications() {
  const [activeCertification, setActiveCertification] = useState<'powerbi' | 'front' | 'back'>('front');
    ...
    <div className="w-full">
      ...
      <div className="flex justify-center space-x-4 mb-8">
        <button
          ...
          className={`px-5 py-2 rounded-lg font-semibold transition duration-300 ${activeCertification === 'front'
        ...
        <button
          ...
          className={`px-5 py-2 rounded-lg font-semibold transition duration-300 ${activeCertification === 'back'
            ? 'bg-blue-700 text-white shadow-md'
            : 'bg-gray-300 text-gray-800 hover:bg-gray-400'
            }`}
        >
        ...
        <button
          ...
          className={`px-5 py-2 rounded-lg font-semibold transition duration-300 ${activeCertification === 'powerbi'
            ? 'bg-blue-700 text-white shadow-md'
            : 'bg-gray-300 text-gray-800 hover:bg-gray-400'
            }`}
        >
