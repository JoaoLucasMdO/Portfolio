...
const images = [
    {
        src: '/certificates/MiniCursoPowerBI.png',
        alt: 'Certificação: Power BI',
        description: 'Certificação do Mini Curso Desenvolvedor Power BI',
        certification: '/certificates/MiniCursoPowerBI.pdf',
    }, 
];
